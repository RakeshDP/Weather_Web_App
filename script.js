// private key
var apiKey = '808adf1bf2513bcaa1a87bbe76ea099b'; // change
var api;
...
function weatherDetails(info){
    if(info.cod == "404"){
        ...
        //let's get required propertiees value from the info object
        ...
        wrapper.querySelector(".temp .numb").innerText = `${Math.floor(temp)}°C`;
        wrapper.querySelector(".weather").innerText = description;
        wrapper.querySelector(".location span").innerText = `${city}, ${country}`;
        wrapper.querySelector(".temp .numb-2").innerText = `${wind} km/hr`;
